...
public class MovementInput : MonoBehaviour
{
    ...
    public GameObject lavethianAxe;
    public GameObject propWeapon;
    ...
    void Update()
    {
        ...
        {
            lavethianAxe.SetActive(true);
            propWeapon.SetActive(false);
            anim.SetBool("callWeapon", true);
        }
        else
        {
            anim.SetBool("callWeapon", false);
        }

        if (Input.GetKeyDown(KeyCode.Q))
        {
            lavethianAxe.SetActive(false);
            propWeapon.SetActive(true);
            anim.SetBool("weaponAway", true);
        }
        else
        {
            anim.SetBool("weaponAway", false);
        }
